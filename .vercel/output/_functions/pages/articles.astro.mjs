...
import { $ as $$ArticleCard } from '../chunks/ArticleCard_COVd2lPf.mjs';
import { $ as $$SearchForm } from '../chunks/SearchForm_DIPMo7bp.mjs';
import { g as getCollection } from '../chunks/_astro_content_DA5aBOML.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "NextStep Digital - Blog" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="space-y-20"> <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-3"> <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8"> <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold">Our Blog</h2> <p class="font-light sm:text-xl">We use an agile approach to test assumptions and connect with the needs of your audience early and often.</p> </div> <br> ${renderComponent($$result2, "SearchForm", $$SearchForm, {})} <br> <div class="grid gap-8 lg:grid-cols-2"> ${allBlogArticles.map((article) => renderTemplate`${renderComponent($$result2, "ArticleCard", $$ArticleCard, { "article": article })}`)} </div> </div> </main> ` })}`;
}, "C:/Users/amalu/OneDrive/Documents/Projects/nextstep-digital/src/pages/articles/index.astro", void 0);

const $$file = "C:/Users/amalu/OneDrive/Documents/Projects/nextstep-digital/src/pages/articles/index.astro";
const $$url = "/articles";
